...
from KaguyaRobot import BOT_USERNAME as BOT_NAME, TRIGGERS as trg, pbot as anibot
from KaguyaRobot.utils.helper import check_user, control_user, media_to_image, rand_key
from KaguyaRobot.utils.data_parser import check_if_adult
from KaguyaRobot.utils.db import get_collection
from KaguyaRobot.modules.anibot_anilist import no_pic
...
@anibot.on_message(filters.command(["whatanime", f"whatanime{BOT_NAME}"], prefixes=trg))
@control_user
