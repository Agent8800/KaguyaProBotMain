...
from KaguyaRobot import pgram as app

from KaguyaRobot.utils.errors import capture_err

from KaguyaRobot.utils.pluginshelper import admins_only

from KaguyaRobot.utils.dbfunctions import is_nsfw_on, nsfw_off, nsfw_on

from KaguyaRobot.utils.filter_groups import nsfw_detect_group

from KaguyaRobot.modules.quote import arq
...
__Use `/anti_nsfw off` to disable this.__

**Nsfw Protection By** __@Natsume_XBot__
...
async def nsfw_enable_disable(_, message):
    ...
    if status == "on":
        ...
        await message.reply_text(
            ...
            "AntiNSFW System On. I will Delete Messages Containing Inappropriate Content."
        ...
        await message.reply_text(" AntiNSFW System Off.")
