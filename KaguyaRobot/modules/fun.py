...
def tslap(update: Update, context: CallbackContext):
    ...
    if user_id == bot.id:
        temp = random.choice(fun_strings.TSLAP_SAITAMA_TEMPLATES)
    ...
    temp = random.choice(fun_strings.TSLAP_TEMPLATES)
...
dispatcher.add_handler(TSLAP_HANDLER)
dispatcher.add_handler(TPAT_HANDLER)
