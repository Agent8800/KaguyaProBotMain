...
import KaguyaRobot.modules.sql.gmute_sql as sql
...
from KaguyaRobot.modules.sql.users_sql import get_all_chats
...
GMUTE_STATUS = CommandHandler("gmutespam", gmutestat, pass_args=True, run_async=True, filters=Filters.group)
